...
const MiniCard = () => {
  ...
  return (
    <a href="/">
      <div className="xl:max-w-[20vw] post-border border-0 lg:border group/mini overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1653103674098-6ed995323607"
          alt="mini-card"
          className="w-full h-72 object-cover object-center group-hover/mini:scale-105 transition-transform duration-200"
        />
